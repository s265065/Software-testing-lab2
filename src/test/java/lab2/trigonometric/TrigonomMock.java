...
public class TrigonomMock {
    ...
    public static CotanCalculator getCotanMock() {
        CotanCalculator cotan = mock(CotanCalculator.class);

        when(cotan.calculate(Mockito.eq(-PI))).thenReturn(Double.POSITIVE_INFINITY);
        when(cotan.calculate(Mockito.eq(- PI / 2))).thenReturn(0.0);
        when(cotan.calculate(Mockito.eq(PI / 2))).thenReturn(0.0);
        when(cotan.calculate(Mockito.eq(PI))).thenReturn(Double.POSITIVE_INFINITY);
        when(cotan.calculate(Mockito.eq(2 * PI))).thenReturn(Double.POSITIVE_INFINITY);

        when(cotan.calculate(Mockito.eq(1 * PI / 6))).thenReturn(1.7320508075688776);
        when(cotan.calculate(Mockito.eq(1 * PI / 4))).thenReturn(1.0000000000000002);
        when(cotan.calculate(Mockito.eq(1 * PI / 3))).thenReturn(0.577350269189626);
        when(cotan.calculate(Mockito.eq(2 * PI / 3))).thenReturn(-0.5773502691896255);
        when(cotan.calculate(Mockito.eq(3 * PI / 4))).thenReturn(-0.9999999999999999);
        when(cotan.calculate(Mockito.eq(5 * PI / 6))).thenReturn(-1.7320508075688776);
        when(cotan.calculate(Mockito.eq(7 * PI / 6))).thenReturn(1.7320508075688785);
        when(cotan.calculate(Mockito.eq(5 * PI / 4))).thenReturn(1.0000000000000002);
        when(cotan.calculate(Mockito.eq(4 * PI / 3))).thenReturn(0.5773502691896265);
        when(cotan.calculate(Mockito.eq(5 * PI / 3))).thenReturn(-0.577350269189626);
        when(cotan.calculate(Mockito.eq(7 * PI / 4))).thenReturn(-0.9999999999999996);
        when(cotan.calculate(Mockito.eq(11 * PI / 6))).thenReturn(-1.7320508075688752);
        when(cotan.calculate(Mockito.eq(-1 * PI / 4))).thenReturn(-1.0000000000000002);
        when(cotan.calculate(Mockito.eq(-3 * PI / 4))).thenReturn(0.9999999999999999);
        when(cotan.calculate(Mockito.eq(-5 * PI / 4))).thenReturn(-1.0000000000000002);
        when(cotan.calculate(Mockito.eq(-7 * PI / 4))).thenReturn(0.9999999999999996);

        when(cotan.calculate(Double.POSITIVE_INFINITY)).thenReturn(NaN);
        when(cotan.calculate(Double.NEGATIVE_INFINITY)).thenReturn(NaN);
        when(cotan.calculate(NaN)).thenReturn(NaN);
